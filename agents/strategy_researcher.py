...
AVAILABLE_STRATEGIES = {
    ...
    "funding_rate_divergence_short": {
        "name": "Funding Rate Divergence SHORT",
        "parameters": {
            "funding_threshold": 0.00005,
        ...
        "description": "INVERSE of long strategy: Short when funding positive + OI increases",
    },
    "liquidation_cascade_short": {
        "name": "Liquidation Cascade SHORT",
        "parameters": {
            "cluster_pct_threshold": 0.90,
            "funding_threshold": 0.00005,
            "tp": 0.06,
        ...
        "description": "INVERSE of long strategy: Short when liquidation spike + green candle + positive funding",
    },
}
